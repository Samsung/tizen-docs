...
<img alt="Main view example of a call app" src="media/4.1.1_a.png" style="height:460px;" />  
...
 
<img alt="The main action is provided as a floating action button on the main view page." src="media/4.1.1_b.png" style="height:460px;" /><img alt="The main action is provided as a floating action button on the main view page." src="media/4.1.1_c.png" style="height:460px; margin-left:10px;" />  
...
<img alt="Displaying content in the detail view" src="media/4.1.2_a.png" style="height:460px;" /><img alt="Displaying content in the detail view" src="media/4.1.2_b.png" style="height:460px; margin-left:10px;" />  
...
<img alt="Action buttons in the detail view" src="media/4.1.2_d.png" style="height:460px;" /><img alt="Action buttons in the detail view" src="media/4.1.2_e.png" style="height:460px; margin-left:10px;" />  
...
<img alt="Screen navigation" src="media/4.1.2_f.png" style="height:460px;" /><img alt="Screen navigation" src="media/4.1.2_g.png" style="height:460px; margin-left:10px;" />  
*Screen navigation*
...
<img alt="Managing multiple items with check boxes" src="media/4.1.3_a.png" style="height:460px;" />  
...
<img alt="Editing settings" src="media/4.1.3_b.png" style="height:460px;" />  
*Editing settings*
