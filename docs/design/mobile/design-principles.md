...
 
<img alt="A floating action button" src="media/1.1.1.z3_floating_button.png" style="height:460px;" />  
...
<img alt="The More menu" src="media/1.1.1.png" style="height:460px;" />  
*The More menu*
...
<img alt="Quick access feature for an Internet browser" src="media/1.2.1.png" style="height:460px;" />  
...
 
<img alt="An active notification." src="media/1.2.2.png" style="height:460px;" />  
...
<img alt="Navigating back from a message" src="media/1.1.3.z3_navigation_back.png" style="height:460px;" />  
...
<img alt="Display important information first" src="media/princicple_contacts_03.png" style="height:460px;" /> <img alt="Display important information first" src="media/princicple_contacts_04.png" style="height:460px; margin-left:10px;" />  
...
<img alt="Clear distinction between different types of information" src="media/princicple_contacts_05.png" style="height:460px;" />  
...
<img alt="A disabled Done button shows that the required field is not filled." src="media/princicple_contacts_06.png" style="height:460px;" /><img alt="A disabled Done button shows that the required field is not filled." src="media/princicple_contacts_07.png" style="height:460px; margin-left:10px;" />  
