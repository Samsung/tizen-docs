...
To use the generated SDK to develope applications with Tizen Studio, see [Configuring the Package Manager](../../sdk-tools/baseline-sdk/setup/advanced-configuration.md) and [Configurable SDK](../../sdk-tools/baseline-sdk/configurable-sdk/configurable-sdk.md).
