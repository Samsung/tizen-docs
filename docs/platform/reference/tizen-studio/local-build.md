...
6. Install the package with the Package Manager.
   ...
   For more information on the Package Manager, see [Configuring the Extension SDK Repository](../../../sdk-tools/baseline-sdk/setup/advanced-configuration.md#configuring-the-extension-sdk-repository).
