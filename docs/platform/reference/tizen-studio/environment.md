...
1. Make sure your computer fulfills the [system requirements](../../../sdk-tools/baseline-sdk/setup/prerequisites.md).
2. [Download](https://developer.tizen.org/development/baseline-sdk/download) and install Tizen Studio.
