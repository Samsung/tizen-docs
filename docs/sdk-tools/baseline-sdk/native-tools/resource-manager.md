...
5. Add code for loading alternative resources by using the [Resource Manager API](/application/native/api/common/latest/group__CAPI__RESOURCE__MANAGER__MODULE.html).![Load resources](./media/resource_manager_add_code.png)
