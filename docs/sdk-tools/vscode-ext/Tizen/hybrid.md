...
To debug dotnet application, set dotnet app as main app, set native app as dependency app to dotnet app. Refer to [Debug your application in emulator](../../../application/dotnet/get-started/first-app.md#debug-your-application-in-emulator) section for details. 
