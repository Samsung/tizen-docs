...
> [!NOTE]
> To run the application faster, enable CPU VT and GPU. If CPU VT is disabled, check [Increasing the Application Execution Speed](emulator.md#speed) for more information. If GPU is disabled, [install the latest vendor-provided graphic driver](../../baseline-sdk/setup/prerequisites.md#emulator).
