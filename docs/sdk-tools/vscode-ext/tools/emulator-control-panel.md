...
- **Key window**
  ...
  You can make the key window appear or disappear through the context menu or a [shortcut key](../../baseline-sdk/common-tools/keyboard-shortcuts.md#emulator).
...
- **Emulator name** (the top row in the menu)
  ...
  The **Detailed Info** window is displayed, showing the **Shortcut Info** and **VM Info** tabs. The **Shortcut Info** tab lists the [emulator keyboard shortcuts](../../baseline-sdk/common-tools/keyboard-shortcuts.md#emulator) and the **VM Info** tab defines the virtual machine details.
...
The instructions for using the features are described below. You can use various [keyboard shortcuts](../../baseline-sdk/common-tools/keyboard-shortcuts.md#ecp) for control panel tasks.
