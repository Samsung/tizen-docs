...
Tizen Studio provides the interface for [running Valgrind with your application](../../../application/native/guides/development/performance.md#running-valgrind) easily. After performance profiling is terminated, you can see the [profiling result](../../../application/native/guides/development/performance.md#viewing-valgrind-result) and use it for improving performance.
