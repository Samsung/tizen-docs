...
<img alt="Tools/options" src="../media/vs2022_hotreload_1.png" />

2. **Enable Hot Reload for Tizen:**
    - Navigate to **Tizen > Tools**.
    - Check the Enable Hot Reload checkbox.
    <img alt="Enable hot reload for tizen" src="../media/vs2022_hotreload_2.png" />
3. **Enable .NET/C++ Hot Reload:**
    - Navigate to **Debugging > .NET/C++ Hot Reload**.
    - Check all available checkboxes.
    <img alt="Enable .NET/C++ hot reload" src="../media/vs2022_hotreload_3.png" />
