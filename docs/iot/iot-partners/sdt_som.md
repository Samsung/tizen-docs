...
| OS |  Support	Samsung Tizen 5.0 Linux
Android (to be updated)
Linux (TBU)
Arm Mbed Linux (TBU) |
| Security | Secure Element (Samsung KONA I)
...
Coin cell charger
OTP memory |
| Serial Peripherals | 	UART, SPI, I2C, PWM, ADC, GPIO
Dual CAN
...
| Environmental | 45 x 42 x 4.5(mm) (W x L x H) dimensions
