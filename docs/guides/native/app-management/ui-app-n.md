...
- EFL
  ...
  For more information on the available application types with EFL, see [EFL Applications](efl-app-n.md).
...
- DALi
  ...
  For more information on the available application types with DALi, see [DALi Applications](dali-app-n.md).