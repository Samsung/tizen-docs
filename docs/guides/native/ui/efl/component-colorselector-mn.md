...
The colorselector UI component allows users to select a color. For more information, see the [Colorselector](../../../../../org.tizen.native.mobile.apireference/group__Colorselector.html) API.
