...
<a name='Tizen.UI.Layouts.ViewExtensions.AbsoluteParam(thisTizen.UI.View)'></a>
...
#### Returns
[AbsoluteParam](Tizen.UI.Layouts.AbsoluteParam.md 'Tizen.UI.Layouts.AbsoluteParam')  
The AbsoluteParam attached to the view.

<a name='Tizen.UI.Layouts.ViewExtensions.FlexParam(thisTizen.UI.View)'></a>
...
The FlexParam attached to the view.

<a name='Tizen.UI.Layouts.ViewExtensions.GridParam(thisTizen.UI.View)'></a>
...
#### Returns
[GridParam](Tizen.UI.Layouts.GridParam.md 'Tizen.UI.Layouts.GridParam')  
The GridParam attached to the view.

<a name='Tizen.UI.Layouts.ViewExtensions.LayoutParam(thisTizen.UI.View)'></a>

## ViewExtensions.LayoutParam(this View) Method

Gets the attached LayoutParam for the view.

```csharp
public static Tizen.UI.Layouts.LayoutParam LayoutParam(this Tizen.UI.View view);
```
#### Parameters
...
The LayoutParam attached to the view.
