...
## IDecoratableText Interface

An interface to express decoratable text.

```csharp
public interface IDecoratableText
```
### Properties

<a name='Tizen.UI.Components.IDecoratableText.Outline'></a>

## IDecoratableText.Outline Property

The outline of the text.

```csharp
System.Nullable&lt;Tizen.UI.Outline> Outline { get; set; }
```
...
## IDecoratableText.Strikethrough Property

The strikethrough of the text.

```csharp
System.Nullable&lt;Tizen.UI.Strikethrough> Strikethrough { get; set; }
```
...
## IDecoratableText.TextShadow Property

The drop shadow of the text.

```csharp
System.Nullable&lt;Tizen.UI.TextShadow> TextShadow { get; set; }
```
...
## IDecoratableText.Underline Property

The underline of the text.

```csharp
System.Nullable&lt;Tizen.UI.Underline> Underline { get; set; }
```
