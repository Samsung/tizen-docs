...
## SelectableVStack Class

Selectable view with vertical stacking layout.
...
## SelectableVStack() Constructor

Constructs a new instance of a ClickableHStack.

```csharp
public SelectableVStack();
```
### Properties

<a name='Tizen.UI.Components.SelectableVStack.ItemAlignment'></a>

## SelectableVStack.ItemAlignment Property
...
## SelectableVStack.Padding Property
...
## SelectableVStack.Spacing Property
