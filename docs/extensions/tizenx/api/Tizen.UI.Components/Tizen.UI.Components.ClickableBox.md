...
Clickable component with .  
It provides [Clicked](Tizen.UI.Components.Clickable.md#Tizen.UI.Components.Clickable.Clicked 'Tizen.UI.Components.Clickable.Clicked') event.

```csharp
public abstract class ClickableBox : Tizen.UI.Components.Clickable,
...
Derived  
&#8627; [ClickableGrid](Tizen.UI.Components.ClickableGrid.md 'Tizen.UI.Components.ClickableGrid')  
&#8627; [ClickableHStack](Tizen.UI.Components.ClickableHStack.md 'Tizen.UI.Components.ClickableHStack')  
&#8627; [ClickableVStack](Tizen.UI.Components.ClickableVStack.md 'Tizen.UI.Components.ClickableVStack')
...
<a name='Tizen.UI.Components.ClickableBox.Children'></a>

## ClickableBox.Children Property
...
<a name='Tizen.UI.Components.ClickableBox.Count'></a>

## ClickableBox.Count Property
...
<a name='Tizen.UI.Components.ClickableBox.IsReadOnly'></a>

## ClickableBox.IsReadOnly Property
...
<a name='Tizen.UI.Components.ClickableBox.Padding'></a>

## ClickableBox.Padding Property
...
<a name='Tizen.UI.Components.ClickableBox.this[int]'></a>

## ClickableBox.this[int] Property
...
<a name='Tizen.UI.Components.ClickableBox.this[int].index'></a>
...
<a name='Tizen.UI.Components.ClickableBox.Clear()'></a>

## ClickableBox.Clear() Method
...
<a name='Tizen.UI.Components.ClickableBox.Contains(Tizen.UI.View)'></a>

## ClickableBox.Contains(View) Method
...
<a name='Tizen.UI.Components.ClickableBox.Contains(Tizen.UI.View).item'></a>
...
<a name='Tizen.UI.Components.ClickableBox.CopyTo(Tizen.UI.View[],int)'></a>

## ClickableBox.CopyTo(View[], int) Method
...
<a name='Tizen.UI.Components.ClickableBox.CopyTo(Tizen.UI.View[],int).array'></a>

`array` Tizen.UI.View[[]](https://docs.microsoft.com/en-us/dotnet/api/System.Array 'System.Array')

<a name='Tizen.UI.Components.ClickableBox.CopyTo(Tizen.UI.View[],int).arrayIndex'></a>

`arrayIndex` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

<a name='Tizen.UI.Components.ClickableBox.GetEnumerator()'></a>

## ClickableBox.GetEnumerator() Method
...
<a name='Tizen.UI.Components.ClickableBox.Insert(int,Tizen.UI.View)'></a>

## ClickableBox.Insert(int, View) Method
...
<a name='Tizen.UI.Components.ClickableBox.Insert(int,Tizen.UI.View).index'></a>

`index` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')

<a name='Tizen.UI.Components.ClickableBox.Insert(int,Tizen.UI.View).item'></a>

`item` Tizen.UI.View

<a name='Tizen.UI.Components.ClickableBox.RemoveAt(int)'></a>

## ClickableBox.RemoveAt(int) Method
...
<a name='Tizen.UI.Components.ClickableBox.RemoveAt(int).index'></a>
...
<a name='Tizen.UI.Components.ClickableBox.System.Collections.Generic.ICollection_Tizen.UI.View_.Add(Tizen.UI.View)'></a>

## ClickableBox.System.Collections.Generic.ICollection&lt;Tizen.UI.View>.Add(View) Method
...
<a name='Tizen.UI.Components.ClickableBox.System.Collections.Generic.ICollection_Tizen.UI.View_.Add(Tizen.UI.View).item'></a>
...
<a name='Tizen.UI.Components.ClickableBox.System.Collections.Generic.ICollection_Tizen.UI.View_.Remove(Tizen.UI.View)'></a>

## ClickableBox.System.Collections.Generic.ICollection&lt;Tizen.UI.View>.Remove(View) Method
...
<a name='Tizen.UI.Components.ClickableBox.System.Collections.Generic.ICollection_Tizen.UI.View_.Remove(Tizen.UI.View).item'></a>
...
<a name='Tizen.UI.Components.ClickableBox.System.Collections.IEnumerable.GetEnumerator()'></a>

## ClickableBox.System.Collections.IEnumerable.GetEnumerator() Method
