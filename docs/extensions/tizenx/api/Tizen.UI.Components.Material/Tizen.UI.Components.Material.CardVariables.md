...
```csharp
public class CardVariables : Tizen.UI.Components.Variables,
...
<a name='Tizen.UI.Components.Material.CardVariables.BackgroundColor'></a>

## CardVariables.BackgroundColor Property
...
## CardVariables.CornerRadius Property
...
## CardVariables.Default Property

Default switch variables.

```csharp
public static Tizen.UI.Components.Material.CardVariables Default { get; }
```
