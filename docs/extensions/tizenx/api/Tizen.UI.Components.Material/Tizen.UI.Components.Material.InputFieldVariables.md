...
## InputFieldVariables Class

Variables used for input field.

```csharp
public class InputFieldVariables : Tizen.UI.Components.Material.InputTextVariables,
...
<a name='Tizen.UI.Components.Material.InputFieldVariables.Default'></a>

## InputFieldVariables.Default Property

Default input field variables.

```csharp
public static Tizen.UI.Components.Material.InputFieldVariables Default { get; }
```
