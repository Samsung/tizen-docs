...
The main features of the Tizen.Uix.Sticker namespace include:
...
To store the sticker information to the Sticker database without using the JSON file, the sticker information must be set into the `Tizen.Uix.Sticker.StickerData` class:
