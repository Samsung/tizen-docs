...
The `SampleOpenTKApp` is generated by Tizen project template. The project draws a triangle that defines vertex, color, shaders and register event handles on `Window` for drawing this triangle.
