...
| `Focused`          | Specifies the state where all the keystrokes and events are recieved by the widget. There can only be one widget in this state at a time in the active window. |
