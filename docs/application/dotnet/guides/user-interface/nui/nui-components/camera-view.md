...
The [CameraView](/application/dotnet/api/TizenFX/latest/api/Tizen.NUI.BaseComponents.CameraView.html) class is the NUI view that displays [camera](/application/dotnet/guides/multimedia/camera.md).
