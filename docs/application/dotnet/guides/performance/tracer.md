...
To use the methods of [Tizen.Tracer](/application/dotnet/api/TizenFX/latest/api/Tizen.Tracer.html), you should include the [Tizen](/application/dotnet/api/TizenFX/latest/api/Tizen.html) namespace in your application:
...
A trace is defined by two API calls: [Begin](/application/dotnet/api/TizenFX/latest/api/Tizen.Tracer.html#Tizen_Tracer_Begin_System_String_) and [End](/application/dotnet/api/TizenFX/latest/api/Tizen.Tracer.html#Tizen_Tracer_End), or [AsyncBegin](/application/dotnet/api/TizenFX/latest/api/Tizen.Tracer.html#Tizen_Tracer_AsyncBegin_System_Int32_System_String_) and [AsyncEnd](/application/dotnet/api/TizenFX/latest/api/Tizen.Tracer.html#Tizen_Tracer_AsyncEnd_System_Int32_System_String_).
...
Here are examples:
  ...
  * Track changes of an integer counter.
   ...
   If you want to track changes of an integer counter of your program in the trace, use [TraceValue](/application/dotnet/api/TizenFX/latest/api/Tizen.Tracer.html#Tizen_Tracer_TraceValue_System_Int32_System_String_).
