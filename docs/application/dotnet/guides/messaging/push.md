...
2. Make sure the following requirements are fulfilled:
    ...
    - [Request the permission for a new application](https://samsungtizenos.com/docs/application/dotnet/guides/messaging/push/request-permission-tizen-push-service)
    - [Extend the expiration date or change the quota](https://samsungtizenos.com/docs/application/dotnet/guides/messaging/push/request-extend-expiration-date-or-change-quota) for an application that already has the permission to use the push messaging service
