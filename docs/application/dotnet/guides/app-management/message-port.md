...
1.  Create a message port instance in each application. To register a local port, call the `Listen()` method of the `Tizen.Applications.Messages.MessagePort` class also.
