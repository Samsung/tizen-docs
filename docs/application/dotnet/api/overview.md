...
| Tizen.Internals.Errors | Provides functions that return the additional information about ErrorCode.
...
| ElmSharp           | ElmSharp is a simple c# wrapper of native EFL elementary which is provide all the widget you need to build a full application. |
