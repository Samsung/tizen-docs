...
<table>
	<tbody>
		<tr>
			...
			<p>This sample application demonstrates how to manage access code and token using <a href="/application/dotnet/api/TizenFX/latest/api/Tizen.Account.OAuth2.html" target="_blank">Tizen.Account.OAuth2</a>.</p>
			</td>
		</tr>
		<tr>
