...
<table>
	<tbody>
		<tr>
			...
			<p>This sample application demonstrates how to work with the Telephony API to receive the call, modem, network, and sim information from the telephony framework.</p>
			</td>
		</tr>
	</tbody>
</table>
...
<table>
	<tbody>
		<tr>
			...
			<td>
			<p><strong>(W) Telephony</strong> [In progress]</p>
			<p>This sample application demonstrates how to work with the Telephony API to receive the call, modem, network, and sim information from the telephony framework.</p>
			</td>
		</tr>
	</tbody>
