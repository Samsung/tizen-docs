...
<table>
	<tbody>
		...
		<tr>
			...
			<p>This sample application demonstrates how to create an image viewer using <a href="https://samsung.github.io/TizenFX/API5/api/Tizen.Content.MediaContent.html" target="_blank">Tizen.Content.MediaContent</a>.</p>
			</td>
		</tr>
		<tr>
			...
			<p>This sample application demonstrates how to obtain and filter media content information from internal and external storages using <a href="https://samsung.github.io/TizenFX/API5/api/Tizen.Content.MediaContent.html" target="_blank">Tizen.Content.MediaContent﻿</a>.</p>
			</td>
		</tr>
	</tbody>
</table>
...
<table>
	<tbody>
		<tr>
			...
			<p>This sample application demonstrates how to download a file using <a href="https://samsung.github.io/TizenFX/API5/api/Tizen.Content.MediaContent.html" target="_blank">Tizen.Content.MediaContent</a>.</p>
			</td>
		</tr>
		<tr>
			<td>
		...
		<td>
			...
			<p>This sample application demonstrates how to convert file extensions to MIME type and MIME type to file extensions using <a href="https://samsung.github.io/TizenFX/API5/api/Tizen.Content.MimeType.html" target="_blank">Tizen.Content.MimeType</a>.</p>
			</td>
		</tr>
	</tbody>
</table>
