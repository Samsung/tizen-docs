...
The Visual Studio Tools for Tizen extension is registered in Visual Studio Marketplace. You can [install the extension](../../../sdk-tools/vstools/install.md) from Visual Studio Marketplace in the Visual Studio IDE.
...
For more information, see the [Visual Studio Tools for Tizen](../../../sdk-tools/vstools/index.md) guides.
    ...
    <div class="col col-6">
        <a href="first-app.md" class="card card-infra card-neutral h-100">
            <div class="card-body">
                ...
                <p class="card-text">An application that is targeted to run on a wide range of Tizen devices such as TVs and IoTs. NUI is a rich GUI library used for creating two-dimensional or three-dimensional applications.</p>
                <p></p>
            </div>
        </a>
    </div>
