...
Before reading this document, we recommend to familiarize with the [Application Lifecycle documentation](/application/dotnet/guides-v2/application/01_application_lfecycle.md).
