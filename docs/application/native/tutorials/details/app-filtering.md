...
| `http://tizen.org/feature/security.privacy_privilege` | Specify this key, if the application requires the privacy privilege information feature to ask user to confirm the privilege status. | 5.0 |
