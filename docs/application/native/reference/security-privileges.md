...
[tizen-manifest.xml](../guides/development/setting-properties.md#setting-the-application-manifest) file.
...
>
> Since Tizen 4.0, the status of privacy-related privileges can be resolved at runtime using the Privacy Privilege Manager API ([API reference](../api/common/latest/group__CAPI__PRIVACY__PRIVILEGE__MANAGER__MODULE.html)).
>
