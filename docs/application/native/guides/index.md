...
- **UIX**
  ...
  | TTS Engine            | Provides functions for operating the Text-To-Speech engine. | [mobile](../api/mobile/latest/group__CAPI__UIX__TTSE__MODULE.html) (since 3.0), [wearable](../api/wearable/latest/group__CAPI__UIX__TTSE__MODULE.html) (since 3.0) | [Text-to-speech Engine](text-input/tts-engine.md) |
