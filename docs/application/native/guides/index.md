...
- **Account**
  ...
  | FIDO Client    | Allows you to utilize the device's available authenticators for online service integration. | [9.0](../api/9.0.0/common/group__CAPI__FIDO__MODULE.html) | FIDO Universal Authentication Framework |
...
- **Location**
  ...
  | API submodule | Functionality                                    | API reference | Guide   |
  | ------------- | ------------------------------------------------ | ------------- | ------- |
  | GeofenceManager | Provides a service related to geofence (geo-fence). | [9.0](../api/9.0.0/common/group__CAPI__GEOFENCE__MANAGER__MODULE.html) | Geofences |
  ...
  | Maps Service    | Provides a set of functions, helping to create map-aware applications. | [9.0](../api/9.0.0/common/group__CAPI__MAPS__SERVICE__MODULE.html) | Maps and Maps Service |
...
- **Messaging**
  ...
  | API submodule | Functionality                                    | API reference | Guide   |
  | ------------- | ------------------------------------------------ | ------------- | ------- |
  | Email | Allows composing, sending, and receiving of email messages.  | [9.0](../api/9.0.0/common/group__CAPI__MESSAGING__EMAIL__MODULE.html) | Email |
  | Messages | Allows composing, sending, and receiving of SMS, MMS, and WAP push messages. | [9.0](../api/9.0.0/common/group__CAPI__MESSAGING__MESSAGES__MODULE.html) | Messages |
...
- **Network**
  ...
  | Wi-Fi        | Manages Wi-Fi connections and monitors the state of Wi-Fi connections. | [9.0](../api/9.0.0/common/group__CAPI__NETWORK__WIFI__PACKAGE.html) | [Wi-Fi](connectivity/wifi.md) |
...
- **Security**
  ...
  | API submodule | Functionality                                    | API reference | Guide   |
  | ------------- | ------------------------------------------------ | ------------- | ------- |
  | CSR                         | Provides the Content Screening Service to scan the content for data, files, and directories, and the Web Protection Service to protect a device by checking whether a URL the user wants to access is risky. | [9.0](../api/9.0.0/common/group__CAPI__CSR__FRAMEWORK__MODULE.html) | [CSR](security/csr.md) |
...
- **UI**
  ...
  | External Output Manager   | Provides functions for external outputs.     | [9.0](../api/9.0.0/common/group__CAPI__UI__EOM__MODULE.html) |  |
