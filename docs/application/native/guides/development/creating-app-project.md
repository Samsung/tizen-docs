...
2. In the Project Wizard, define the project details.
   ...
   e. Define the project properties and click **Finish**.
      ...
      The Project Wizard sets up the project, creates the application files using the default content from the template, and closes. For more information on the Project Wizard and the available templates, see [Creating Tizen Projects with Tizen Project Wizard](../../../../sdk-tools/tizen-studio/native-tools/project-wizard.md).
