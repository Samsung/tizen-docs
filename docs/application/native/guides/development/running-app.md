...
You can run Tizen native applications on the [emulator](../../../../sdk-tools/baseline-sdk/common-tools/emulator.md) using the **Project Explorer** view or the Tizen Studio menu.
