...
You can export the provider functionalities of your Tizen native service application in the [application project settings](../../../../org.tizen.training/html/native/process/setting_properties_n.htm#manifest) in the Tizen Studio. The provider ID, type, and accessibility must be specified for the available data control.
