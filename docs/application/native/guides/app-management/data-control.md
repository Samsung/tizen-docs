...
1. Implement the provider application:
   ...
   2. Register the operation callbacks within the `app_create()` function (generated by Tizen Studio) using the `data_control_provider_map_register_cb()` function:
...
2. Implement the consumer application:
   ...
   2. To identify the provider and data, initialize a data control handler within the `app_create()` function generated by Tizen Studio:
