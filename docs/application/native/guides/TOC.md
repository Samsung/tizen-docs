...
## [Attach Panel](notification/attach-panel.md)
## [Minicontrol Window](notification/minicontrol.md)

# Alarms and Scheduling
## [Overview](alarm/overview.md)
## [Alarms](alarm/alarms.md)
## [Contextual System Event Trigger](alarm/trigger.md)

# Media and Camera
## [Overview](multimedia/overview.md)
## Media Content and Metadata
### [Media Content](multimedia/media-content.md)
### [Metadata](multimedia/metadata.md)
## [Image Editing](multimedia/image-edit.md)
## [Thumbnail Images](multimedia/thumbnail-images.md)
## Visual Detection and Recognition
### [Barcode Detection and Generation](multimedia/image-barcode.md)
### [Face Detection, Recognition, and Tracking](multimedia/face-detection.md)
### [Image Recognition and Tracking](multimedia/image-recognition.md)
## Audio Management
### [OpenAL](multimedia/openal.md)
### [Sound Manager](multimedia/sound.md)
...
## [Media Muxing](multimedia/media-muxing.md)
## [Media Stream Playback](multimedia/media-streams.md)
## [Media Stream Recording](multimedia/stream-recorder.md)
...
### [Connection Management](connectivity/connection.md)
### [Download](connectivity/download.md)
### [Curl](connectivity/curl.md)
### [HTTP](connectivity/http.md)
### [Service Access through Plugins](connectivity/plugins.md)
### [Web View](connectivity/web-view.md)
## [File Transfer with MTP](connectivity/mtp.md)
## [VPN Connections](connectivity/vpn.md)
## [IoT Connectivity](connectivity/iotcon.md)
## [Network Service Discovery](connectivity/nsd.md)

# Messaging
## [Overview](messaging/overview.md)
## [Email](messaging/email.md)
## [Messages](messaging/messages.md)
## [Push](messaging/push.md)
## [Push Server](messaging/push-server.md)

# Location and Sensors
## [Overview](location-sensors/overview.md)
## [Geofences](location-sensors/geofences.md)
## [Location Information](location-sensors/location.md)
## Maps and Maps Service
### [Overview](location-sensors/maps.md)
### [Getting HERE Maps Credentials](location-sensors/here-credentials.md)
## [Device Sensors](location-sensors/device-sensors.md)
## [Activity Recognition](location-sensors/activity.md)
## [Gesture Recognition](location-sensors/gesture.md)

# Text Input and Voice
## [Overview](text-input/overview.md)
## [Input Method](text-input/input-method.md)
## [Speech-to-text](text-input/stt.md)
## [Text-to-speech](text-input/tts.md)
## [Voice Control](text-input/voice-control.md)

# Personal Data
## [Overview](personal/overview.md)
## [Account Management](personal/account.md)
## [Data Synchronization](personal/data-sync.md)
## Authentication and Authorization
### [FIDO Universal Authentication Framework](personal/fido.md)
### [OAuth 2.0](personal/oauth.md)
...
## [Privacy-related Permissions](security/privacy-related-permissions.md)
