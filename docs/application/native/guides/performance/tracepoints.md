...
You can perform trace operations in Tizen native applications with the [T-trace tool](../../../../sdk-tools/tizen-studio/native-tools/t-trace.md). The tool allows you to generate traces and visualize them.
