...
You can perform trace operations in Tizen native applications with the [T-trace tool](../../../../sdk-tools/baseline-sdk/native-tools/t-trace.md). The tool allows you to generate traces and visualize them.
