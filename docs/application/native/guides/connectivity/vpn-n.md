...
- VPN profile
  ...
  - The `vpnsvc_h` handle is used to [configure the tunnel interface](#config) before using the [VPN application control](../app-management/common-appcontrol-n.md#vpnservice) to ask the user permission to connect to the VPN service.
...
1. Define a function to launch the [VPN application control](../app-management/common-appcontrol-n.md#vpnservice) and a callback to handle the results:
