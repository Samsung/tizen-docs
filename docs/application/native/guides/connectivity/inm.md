...
> [!NOTE]
> You can test the INM functionality on a target device only. The [Tizen emulator](../../../../sdk-tools/baseline-sdk/common-tools/emulator.md) does not support this feature.
