...
- Call information
  ...
  You can [retrieve information about the current call](#call_use) by using the [Call API](../../api/wearable/latest/group__CAPI__TELEPHONY__INFORMATION__CALL.html) to retrieve a list of current call handles. You can also access voice and video call states, and use the state information in call-related actions.
...
- Network information
  ...
  You can [retrieve information about the current cellular network and telephony service](#network_use) using the [Network API](../../api/wearable/latest/group__CAPI__TELEPHONY__INFORMATION__NETWORK.html). You can get, for example, the cell ID, LAC (Location Area Code), network type, and network name of the current cellular network and telephony service.
...
1. To use the [Telephony Information API](../../api/wearable/latest/group__CAPI__TELEPHONY__INFORMATION.html), the application has to request permission by adding the following privileges to the `tizen-manifest.xml` file:
...
To get the voice and video call state and be notified when the user makes a voice or video call or hangs up the phone, use the [Call API](../../api/wearable/latest/group__CAPI__TELEPHONY__INFORMATION__CALL.html).
...
To extract information stored on a SIM card, use the [SIM API](../../api/wearable/latest/group__CAPI__TELEPHONY__INFORMATION__SIM.html).
...
To get the state, call the `telephony_sim_get_state()` function. It returns the SIM card state in its second parameter, using the values of the `telephony_sim_state_e` [enumerator](../../api/wearable/latest/group__CAPI__TELEPHONY__INFORMATION__SIM.html#ga08448f4cfaf7c59cd585008d3bf32b70).
...
To access information about the current cellular network and telephony service, use the [Network API](../../api/wearable/latest/group__CAPI__TELEPHONY__INFORMATION__NETWORK.html).
...
To get the state, call the `telephony_network_get_service_state()` function. It returns the network service state in its second parameter, using the values of the `telephony_network_service_state_e` [enumeration](../../api/wearable/latest/group__CAPI__TELEPHONY__INFORMATION__NETWORK.html#gae9f3b6e54a1086b8734f4acc71fd001b).
...
To access information about the modem, use the [Modem API](../../api/wearable/latest/group__CAPI__TELEPHONY__INFORMATION__MODEM.html).
