...
Asynchronous transfers, including isochronous and control transfers, are explained with examples on [their API page](../../api/mobile/latest/group__CAPI__USB__HOST__ASYNC__MODULE.html).
