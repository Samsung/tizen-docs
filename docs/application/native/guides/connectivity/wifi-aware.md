...
> [!NOTE]
> You can test the Wi-Fi Aware functionality on a target device only. The [emulator](../../../../sdk-tools/baseline-sdk/common-tools/emulator.md) does not support this feature.
