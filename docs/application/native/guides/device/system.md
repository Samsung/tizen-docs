...
| Key                                      | Type   | Description                              |
|------------------------------------------|--------|------------------------------------------|
| `http://tizen.org/feature/thermistor.ap` | `bool` | The platform returns `true` for this key, if the device supports a thermistor for Application Processor. |
| `http://tizen.org/feature/thermistor.cp` | `bool` | The platform returns `true` for this key, if the device supports a thermistor for Communications Processor. |
| `http://tizen.org/feature/thermistor.battery` | `bool` | The platform returns `true` for this key, if the device supports a thermistor for Battery. |
