...
To use the functions and data types of the [System Settings API](../../api/common/latest/group__CAPI__SYSTEM__SYSTEM__SETTINGS__MODULE.html), include the `<system_settings.h>` header file in your application:
...
2. Obtain the setting data.
   ...
   The available settings are defined in the [`system_settings_key_e` enumerator](../../api/common/latest/group__CAPI__SYSTEM__SYSTEM__SETTINGS__MODULE.html#ga56c8fa435516884c5648efecdd871eaa).
...
The [`system_settings_key_e` enumerator](../../api/common/latest/group__CAPI__SYSTEM__SYSTEM__SETTINGS__MODULE.html#ga56c8fa435516884c5648efecdd871eaa) defines all enumerations that work as parameters for the System Settings API.
...
| `SYSTEM_SETTINGS_KEY_ULTRA_DATA_SAVE`    | `int`    | `GETTER, NOTIFIER`      | Ultra Data Save status, which can be one of the [`system_settings_uds_state_e` enumeration values](../../api/common/latest/group__CAPI__SYSTEM__SYSTEM__SETTINGS__MODULE.html#ga59ffa706c8964ee1f6c6ab03b4efdac1). |
...
- Dependencies
  - Since Tizen 2.4
- API References
  - [System Settings API](../../api/common/latest/group__CAPI__SYSTEM__SYSTEM__SETTINGS__MODULE.html)
