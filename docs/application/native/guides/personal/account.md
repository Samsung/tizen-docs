...
1. To use the [Account Manager API](../../api/common/latest/group__CAPI__ACCOUNT__MANAGER__MODULE.html), the application has to request permission by adding the following privileges to the `tizen-manifest.xml` file:
...
1. Select the secrecy level using the [`account_secrecy_state_e` enumeration](../../api/common/latest/group__CAPI__ACCOUNT__MANAGER__MODULE.html#ga41a7e7e7cfb072d0b0ba37087a0535b6):
