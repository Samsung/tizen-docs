...
1. To use [the OAuth 2.0 API](../../api/common/latest/group__CAPI__OAUTH2__MODULE.html), the application has to request permission by adding the following privilege to the `tizen-manifest.xml` file:
