...
1. To use the [CSR API](../../api/9.0.0/common/group__CAPI__CSR__FRAMEWORK__MODULE.html), the application has to request permission by adding the following privileges to the `tizen-manifest.xml` file:
