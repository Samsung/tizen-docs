...
1. To use the [Notification API](../../api/common/latest/group__NOTIFICATION__MODULE.html), the application has to request permission by adding the following privilege to the `tizen-manifest.xml` file:
...
The parameter is the notification type, whose possible values are listed in the [`_notification_type` enumeration](../../api/common/latest/group__NOTIFICATION__MODULE.html#ga0809cf2728f6e60d54ba8ddf9aa7db20).
...
- Notification text:
  ...
  The second parameter defines the notification type, whose possible values are listed in the [`_notification_text_type` enumeration](../../api/common/latest/group__NOTIFICATION__MODULE.html#ga1b932c18e0430b4cd3a09da98d1fb41b).
...
- Notification image:
  ...
  The second parameter defines the notification image type, whose possible values are listed in the [`_notification_image_type` enumeration](../../api/common/latest/group__NOTIFICATION__MODULE.html#gaa285a3f74abc58d1cb0b78f0bfd09ed5).
...
- Notification display options:
  ...
  The second parameter defines the notification display option, whose possible values are listed in the [`_notification_display_applist` enumeration](../../api/common/latest/group__NOTIFICATION__MODULE.html#ga12754b4babd618f4870d9fb2904e19ae). You can set multiple options with the "|" pipe operation.
...
- LED options:
  ...
  - The `notification_set_led()` function sets the LED operation. The second parameter defines the LED notification, whose values are listed in the [`_notification_led_op` enumeration](../../api/common/latest/group__NOTIFICATION__MODULE.html#gaa96099d9bff211107f6b200eeb92e1d9).
...
- Notification properties:
  ...
  The second parameter defines the notification property, whose possible values are listed in the [`_notification_property` enumeration](../../api/common/latest/group__NOTIFICATION__MODULE.html#ga70f1e4c6f3d36e09d0a9bdff7d6807c3). You can set multiple properties with the "|" pipe operation.
...
- Button on the active notification:
  ...
  - The `notification_add_button()` adds the button. The second parameter defines the button index, whose possible values are listed in the [`_notification_button_index` enumeration](../../api/common/latest/group__NOTIFICATION__MODULE.html#ga2b8eaa47c666ec055def59c32eab419b).

  - The `notification_set_event_handler()` function defines the application control that launches the application at the button click. The third parameter defines the app control handle, whose possible values are listed in the [`_notification_event_type` enumeration](../../api/common/latest/group__NOTIFICATION__MODULE.html#ga38d5cdc16c56dbe88d821995f82b0799).
