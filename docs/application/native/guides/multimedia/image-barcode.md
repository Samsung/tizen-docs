...
1. To use the functions and data types of the [Media Vision BarCode API](../../api/common/latest/group__CAPI__MEDIA__VISION__BARCODE__MODULE.html), include the `<mv_barcode.h>` header file in your application:
