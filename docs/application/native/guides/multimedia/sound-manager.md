...
To use the functions and data types of the [Sound Manager API](../../api/common/latest/group__CAPI__MEDIA__SOUND__MANAGER__MODULE.html), include the `<sound_manager.h>` header file in your application:
...
You can manage the volume level of a particular sound type. With the [Sound Manager API](../../api/common/latest/group__CAPI__MEDIA__SOUND__MANAGER__MODULE.html), you can set and get a volume level and a maximum volume level of a particular sound type.
...
You can manage sound streams with sound stream information handles. Once a handle created, it is used in the stream playback and recording APIs, such as [Player](../../api/common/latest/group__CAPI__MEDIA__PLAYER__MODULE.html), [WAV Player](../../api/common/latest/group__CAPI__MEDIA__WAV__PLAYER__MODULE.html), and [Audio I/O](../../api/common/latest/group__CAPI__MEDIA__AUDIO__IO__MODULE.html), to manage your sound streams. An application can have multiple stream information handles and each handle can have multiple sound streams.
...
- Acquiring stream focus
  ...
  To set the stream focus type, use the values of the [`sound_stream_focus_mask_e` enumeration](../../api/common/latest/group__CAPI__MEDIA__SOUND__MANAGER__STREAM__POLICY__MODULE.html#ga7087e13ccf2fe610dd1a93b2226f2e72).
