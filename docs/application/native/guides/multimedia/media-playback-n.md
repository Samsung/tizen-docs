...
- Through the multimedia application control **in mobile applications only**When using the [multimedia application control](../app-management/common-appcontrol-n.md#multimedia), the device standard media player application is launched to play audio.
...
1. To start the WAV player, use the `wav_player_start()` function.
   ...
   To set the path of your WAV file, you may need to retrieve the default path for audio files. For more information, see the [Data Storages](../data/data-storages-n.md) guide.
