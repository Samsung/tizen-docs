...
DALi animations [occur in a dedicated thread](dali-rendering.md#animations-with-multi-threading). This allows animations to run smoothly, regardless of the time taken to process the input, events, and other factors in the application code.
