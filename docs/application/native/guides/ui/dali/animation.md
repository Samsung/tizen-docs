...
DALi animations [occur in a dedicated thread](rendering-effects.md#animations). This allows animations to run smoothly, regardless of the time taken to process the input, events, and other factors in the application code.
