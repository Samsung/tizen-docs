...
- Viewing the log output
  ...
  - In your IDE (when testing with an emulator), use the log view.
...
1. To use the functions and data types of the [dlog API](../../api/common/latest/group__CAPI__SYSTEM__DLOG.html), include the `<dlog.h>` header file in your application:
...
For information on connecting to the target and using it with SDB, see [Connecting Devices over Smart Development Bridge](../../../../sdk-tools/baseline-sdk/common-tools/smart-development-bridge.md).
