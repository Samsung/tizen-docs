...
- [Component-Based Applications](component-based-app.md)
  ...
  The Component-Based application provides a way to implement multiple model application. It means you can provide multiple service component and multiple frame component in one application process. The frame component has a window and a lifecycle to manage user interfaces. The service component does not has a window and runs in the background. Every registered component can create multiple intances.
