...
Before using graphics libraries in Tizen, make sure you understand the basic functions of [OpenGL® ES](https://www.khronos.org/opengles/) and [Vulkan®](https://www.khronos.org/vulkan). For more information, see [SDL Graphics with OpenGL® ES](sdl-opengles.md) and [SDL Graphics with Vulkan®](vulkan.md).
