...
The Tizen Studio provides the interface for [running Valgrind with your application](../../native/guides/development/performance.md#running-valgrind) easily. After performance profiling is terminated, you can see the [profiling result](../../native/guides/development/performance.md#viewing-valgrind-result) and use it for improving performance.
