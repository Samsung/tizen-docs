# In-App Purchase
This page explains the process of using the In-Application Purchases(IAP). Read this page thoroughly before using the IAP.

By selling items from within your application, you can generate considerable revenue. You can implement IAP in your application using the AppControl mechanism for Tizen native and Web applications.
