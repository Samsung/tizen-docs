...
The certification process is necessary not only for testing your apps on the actual devices but also for uploading them to the Galaxy Store.
...
- [Creating a Certificate Profile](cert-create-profile.md)
- [Managing Certificate Profiles](cert-manage-profile.md)

## Tizen Certificate

The Tizen certificate follows the exact specifications of [XML Digital Signature for widgets](http://www.w3.org/TR/widgets-digsig/) from W3C.
...
**Critical:** Keep this key safe. If you lose it, you cannot update your own app. To maintain application identity, the author key must be stored carefully and protected from loss.
