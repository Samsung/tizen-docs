...
-   [Wearable Web application using Template](../web/get-started/wearable/first-app.md)

    A wearable application is targeted to run on smart watches, and can be optimized for the smaller screen.

-   [Wearable Web application using Sample](../web/get-started/wearable-watch/first-app-watch.md)
