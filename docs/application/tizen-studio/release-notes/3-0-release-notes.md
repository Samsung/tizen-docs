...
-   SmartThings
	...
	-  two process model support added for iot-headed and iot-headless profiles
...
-   SDB
	-  added support for automatic command exchange between pllugin supported daemon and server
