...
- Multi App and Hybrid App support
  - Added the following Multi app and Hybrid app support in [CLI (TZ)](https://docs.tizen.org/application/tizen-studio/tizen-core/tizen-core-cli/), [VS](https://docs.tizen.org/application/vstools/Tizen/hybrid), and [VSCode](https://docs.tizen.org/application/vscode-ext/Tizen/hybrid) extension for Tizen
