...
-   Native UI Builder
    -   Fixed build error when adding Button on table widgets by cut-paste from another container.
    -   Fixed Toolbar widget not getting deleted after deleting from Outline view.
