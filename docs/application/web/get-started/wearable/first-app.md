...
-   **Automatically**
    ...
    To use the automatic build, follow the steps below:
...
You can run the Web application on the [emulator](../../guides/development/run-debug-app.md#emulator) or a [real target device](../../guides/development/run-debug-app.md#target).
...
There are various ways to connect CSS with HTML, they are as follows:
