...
1.  Download and install Tizen Studio with Samsung TV certificate extension and Samsung TV SDK Tools. For more information on the installation process, see the [installation guide](../../../tizen-studio/setup/install-sdk.md).
...
4.  [Build and Run the application](#run)
...
Your application project is now ready for further actions. Next, continue with application configuration.
...
-   [Real target device](../../tutorials/process/run-debug-app.md#target).
...
1.   Launch an emulator instance in the [Emulator Manager](../../../tizen-studio/common-tools/emulator-manager.md):
   ...
   2.  In the Emulator Manager window, select a TV emulator from the list and click  **Launch**. If no applicable emulator instance exists you can [create a new one](../../../tizen-studio/common-tools/emulator-manager.md#create).
...
3. Run the application:
  ...
  1.  In the  **Project Explorer**  view, right-click the project and select  **Run As \> Tizen Web Application**.
      ...
      If you have created multiple emulator instances, select desired instance using the combo box in the toolbar before you run the application. If you select an offline emulator, it gets automatically launched when you select to run the application.
...
1. Connect the TV target device to your computer:
    ...
    2. In the Tizen Studio, use the Remote Device Manager to connect the TV:
        ...
        1. In the **Device Manager** , click the  **Remote Device Manager**
        ...
        4. In the **Remote Device Manager**  window, switch the new device on by toggling the switch under **Connect**.
...
The UI is created using [W3C/HTML](https://www.w3schools.com). The W3C specifications provide HTML and CSS features for creating a user interface. With HTML, you can define the structure of the application screens, while
 

CSS allows you to define the look and feel of the screens.
