...
For more information on updating packages, see [Updating Tizen Studio](../../../../sdk-tools/baseline-sdk/setup/update-sdk.md).
...
3. In the Project Wizard, define the project details.
    ...
    5. Define the project properties and click **Finish**.
        ...
        The Project Wizard sets up the project, creates the application files using the default content from the template, and closes. For more information on the Project Wizard and the available templates, see [Create Tizen Projects with Tizen Project Wizard](../../../../sdk-tools/baseline-sdk/web-tools/project-wizard.md).
