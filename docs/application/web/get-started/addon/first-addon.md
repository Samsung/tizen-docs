...
1.  Before you get started with developing Tizen addons, download and install [Tizen Studio](../../../../sdk-tools/baseline-sdk/index.md).
...
When you are developing a more complex addon, you can take advantage of the [Web tools included in Tizen Studio](../../../../sdk-tools/baseline-sdk/web-tools/index.md) to ease the tasks of creating functionality and designing the addon UI.
...
3.  In the Project Wizard, define the project details.
    ...
    5.  Define the project properties and click **Finish**.
        ...
        The Project Wizard sets up the project, creates the addon files using the default content from the template, and closes. For more information on the Project Wizard and the available templates, see [Creating Tizen Projects with Tizen Project Wizard](../../../../sdk-tools/baseline-sdk/web-tools/project-wizard.md).
...
1.  Launch an emulator instance in [Emulator Manager](../../../../sdk-tools/baseline-sdk/common-tools/emulator-manager.md):
...
2.  Generate a security profile.
    ...
    Before you run the addon, you must [sign your addon package with a certificate profile](../../../../sdk-tools/baseline-sdk/common-tools/certificate-registration.md) in Tizen Studio.
