...
You can run the Web application on the [emulator](../../guides/development/run-debug-app.md#emulator), [Web Simulator](../../guides/development/run-debug-app.md#simulator), or a [real target device](../../guides/development/run-debug-app.md#target).
