...
You can run the Web application on the [emulator](../../tutorials/process/run-debug-app-w.md#emulator), [Samsung TV Simulator](http://developer.samsung.com/tv/develop/getting-started/using-sdk/tv-simulator), or a [real target device](../../tutorials/process/run-debug-app-w.md#target).
