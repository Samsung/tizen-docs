...
You can run the Web application on the [emulator](../../tutorials/process/run-debug-app-w.md#emulator), [Web Simulator](../../tutorials/process/run-debug-app-w.md#simulator), or a [real target device](../../tutorials/process/run-debug-app-w.md#target).
...
For more information on using the Web Simulator features, see [Taking Advantage of Web Simulator Features](../../../tizen-studio/web-tools/web-simulator-features-w.md).
...
The UI is created using [W3C/HTML](../../guides/w3c/w3c-cover-w.md). The W3C specifications provide HTML and CSS features for creating a user interface. With HTML, you can define the structure of the application screens, while CSS allows you to define the look and feel of the screens.
