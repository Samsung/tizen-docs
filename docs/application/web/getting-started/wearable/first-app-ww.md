...
You can run the Web application on the [emulator](../../tutorials/process/run-debug-app-w.md#emulator) or a [real target device](../../tutorials/process/run-debug-app-w.md#target).
