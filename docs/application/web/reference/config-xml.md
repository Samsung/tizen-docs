...
> [!NOTE]
> The `config.xml` must conform to both the XML file format and the W3C specification requirements.
	...
	<thead>
		...
		<tr>
			...
			<ul>
				...
				<p>The project name is a set of characters (0~9, a~z, A~Z) randomly generated by the project wizard. The minimum value is 1 byte and the maximum value is 52 bytes.</p>
				</li>
				<li><code>package</code>
				<p>Mandatory; Tizen package ID generated by the project wizard, consisting of 10 characters (0~9, a~z, A~Z). The package ID is unique in the Samsung Apps.</p>
				</li>
