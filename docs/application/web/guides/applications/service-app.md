...
> [!NOTE]
> The TV Web service requires partner-level certification in Tizen 3.0.
...
2. To ensure that a Web service is acknowledged by the platform, you must add a Web service extension element (`<tizen:service>`) to the `config.xml` file of the application:
   ...
   The definition of all service elements is listed and explained in the [Extending Configuration Elements](../../../../sdk-tools/baseline-sdk/web-tools/config-editor.md#ww_extend).
