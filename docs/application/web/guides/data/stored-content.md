...
- Playlist management   
  ...
  Using the `Playlist` interface (in [mobile](../../api/latest/device_api/mobile/tizen/content.html#Playlist), [wearable](../../docs/application/native/guides/app-management/app-preferences.md 8번 line, api/Mobile
/device_api/wearable/tizen/content.html#Playlist), and [TV](../../docs/application/native/guides/app-management/app-preferences.md 8번 line, api/Mobile
/device_api/tv/tizen/content.html#Playlist) applications), you can:
