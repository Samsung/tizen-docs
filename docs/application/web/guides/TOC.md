...
## [Device Motions](cordova/devicemotion.md)
## [Event Handling](cordova/events.md)
## [File Management](cordova/file.md)
## [File Transfers](cordova/filetransfer.md)
## [Globalization](cordova/globalization.md)
## [Media Playback and Recording](cordova/media.md)
## [Network Information](cordova/network-information.md)
...
## [Secure Element Access](connectivity/secure-element.md)
...
## [Call History](personal/call-history.md)
...
## [Time and Date Management](device/time.md)
## [Web View Settings](device/web-view.md)
...
### [DeviceOrientation Event Specification](w3c/device/device-orientation.md)
### [Touch Events](w3c/device/touch.md)
### [Vibration](w3c/device/vibration.md)
### [HTML5 Browser state](w3c/device/browser-state.md)
### [Screen Orientation](w3c/device/screen-orientation.md)
## Graphics
### [Overview](w3c/graphics/graphics-guide.md)
### [HTML5 Canvas](w3c/graphics/canvas.md)
### [SVG](w3c/graphics/svg.md)
## MultiMedia
### [Overview](w3c/multimedia/media-guide.md)
### [getUserMedia](w3c/multimedia/getusermedia.md)
### [HTML5 video and audio element](w3c/multimedia/video-audio.md)
### [HTML Media Capture](w3c/multimedia/media-capture.md)
### [Web Audio](w3c/multimedia/webaudio.md)
## Communication
### [Overview](w3c/communication/comm-guide.md)
## [HTML5 Web Messaging](w3c/communication/web-messaging.md)
### [WebSocket](w3c/communication/websocket.md)
### [XMLHttpRequest](w3c/communication/xmlhttprequest.md)
### [Server-Sent Events](w3c/communication/server-sent.md)
## Storage
### [Overview](w3c/storage/storage-guide.md)
### [File](w3c/storage/file.md)
### [Indexed Database](w3c/storage/indexdb.md)
### [Web Storage](w3c/storage/web-storage.md)
### [HTML5 Application caches](w3c/storage/appcache.md)
### [Web SQL Database](w3c/storage/websql.md)
## Security
### [Overview](w3c/security/security-guide.md)
### [Cross-Origin Resource Sharing](w3c/security/cors.md)
### [HTML5 iframe element](w3c/security/iframe.md)
...
### [Web Workers](w3c/perf-opt/web-workers.md)
### [JavaScript Performance Improvement](w3c/perf-opt/js-performance-improvement.md)
### [JavaScript and CSS Minification](w3c/perf-opt/minify-js-css.md)
...
### [HTML5 Forms](w3c/ui/html5forms.md)
### [Selectors API (Level 1 and 2)](w3c/ui/selector.md)
### [Media Queries](w3c/ui/media-query.md)
### [Multiple Screen Support](w3c/ui/multiple-screens.md)
### [Multiple UI Layouts](w3c/ui/ui-layout.md)
### [Frame Flattening](w3c/ui/frame-flattening.md)
### [HTML5 Session History](w3c/ui/session-history.md)
### [Clipboard API and events](w3c/ui/clipboard.md)
### [HTML5 Drag and Drop](w3c/ui/drag-drop.md)
### [CSS Transforms](w3c/ui/transform.md)
### [CSS Animations Module (Level 3)](w3c/ui/animation.md)
### [CSS Transitions Module (Level 3)](w3c/ui/transition.md)
### [CSS Color Module (Level 3)](w3c/ui/color.md)
### [CSS Backgrounds and Borders Module (Level 3)](w3c/ui/background.md)
### [CSS Flexible Box Layout Module](w3c/ui/flexible.md)
### [CSS Multi-column Layout Module](w3c/ui/multi.md)
### [CSS Text Module (Level 3)](w3c/ui/text-module.md)
