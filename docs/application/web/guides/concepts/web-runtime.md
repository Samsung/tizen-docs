...
guidelines](https://www.w3.org/TR/widgets/){:target="_blank"}. However, unlike packaged Web applications, the hosted Web applications have an externally hosted document as their starting page. For more information, see [Extending Configuration Elements](../../reference/config-xml.md#ww_extend).
...
[`<tizen:setting/>`](../../reference/config-xml.md#ww_setting)
