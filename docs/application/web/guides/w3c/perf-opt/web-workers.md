...
You can test the application performance using the [Web Inspector](../../../../../sdk-tools/baseline-sdk/web-tools/web-inspector.md). In the Timeline panel, the event of performing all the calculations in a single UI thread creates a delay of 16218 milliseconds.
