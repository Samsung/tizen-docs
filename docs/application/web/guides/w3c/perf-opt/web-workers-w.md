...
- [Creating workers](./w3c/perf_opt/web-workers-w.md#Creating_Web_Worker)
...
- [Messaging between workers](./w3c/perf_opt/web-workers-w.md#Sending_Messages)
...
- [Multi-threading](./w3c/perf_opt/web-workers-w.md#multi)
...
- [Problems with using UI threads](./w3c/perf_opt/web-workers-w.md#uithread)
- [Advantages of using multi-thread Web workers](./w3c/perf_opt/web-workers-w.md#multithread) 
...
You can test the application performance using the [Web Inspector](../../../../org.tizen.studio/html/web_tools/web_inspector_w.htm). In the [Timeline panel](../../../../org.tizen.studio/html/web_tools/web_inspector_w.htm#time), the event of performing all the calculations in a single UI thread creates a delay of 16218 milliseconds.
...
- [JavaScript performance improvement](./w3c/perf_opt/js-performance-improvement-w.md)
- [JavaScript and CSS minification](./w3c/perf_opt/minify-js-css-w.md)
- [jQuery performance improvement](./w3c/perf_opt/jquery-performance-improvement-w.md)