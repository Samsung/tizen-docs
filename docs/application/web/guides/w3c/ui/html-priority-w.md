...
- In the `style.css` file:`@import url("priorities1.css");p: after {content: " : linked in head"}`**Figure: Result of linking the @import attribute**![Result of linking the @import attribute](./media/import_linked_in_head.png)
