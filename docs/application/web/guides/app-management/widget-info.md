...
Using the `WidgetServiceManager` interface, you can:
...
1. Define a success handler implementing the `WidgetArraySuccessCallback` interface. Optionally, you can specify an error handler too:
...
Using the `Widget` interface, you can:
...
> [!NOTE]
> The `WidgetInstance.id` value is volatile and can change after device reboot.

1. Define a success handler implementing the `WidgetInstancesCallback` interface. Optionally, you can specify an error handler too:
...
1. Define a success handler implementing the `WidgetVariantsCallback` interface. Optionally, you can specify an error handler too.
...
1. Define the event handler for state notifications using the `WidgetChangeCallback` listener interface:
...
2. Retrieve the widget object using the `getWidget()` method of the `WidgetServiceManager` interface:
...
Using the `WidgetInstance` interface, you can:
...
3. To retrieve widget instance content, define a success handler implementing the `WidgetContentCallback` interface. Optionally, you can specify an error handler too:
