...
| `SystemInfoVideoSource` (in [TV](../../api/latest/device_api/tv/tizen/systeminfo.html#SystemInfoVideoSource) applications) | `VIDEOSOURCE`                | Provides information about connected and disconnected devices. |
...
| `SystemInfoServiceCountry` (in [TV](../../api/latest/device_api/tv/tizen/systeminfo.html#SystemInfoServiceCountry) applications) | `SERVICE_COUNTRY`                | Represents a country of which basic policy of terms and conditions is set. |
| `SystemInfoSourceInfo` (in [TV](../../api/latest/device_api/tv/tizen/systeminfo.html#SystemInfoVideoSourceInfo) applications) | `SOURCE_INFO`                | Provides information about current video source of device, eg. TV, HDMI1, HDMI2 etc. |
