...
class DocsIndex:
    ...
    def generated(self, path):
        ...
        Uses the first matching class, not mere membership of the generated
        one, so the api-handwritten escape hatch actually takes effect. Asking
        for membership meant a page listed as hand-written was still treated as
        generated by every rule that consults this, which silently skipped it.
        """
        entry = self.config.classify(path)
        return bool(entry and entry.id == "generated")
